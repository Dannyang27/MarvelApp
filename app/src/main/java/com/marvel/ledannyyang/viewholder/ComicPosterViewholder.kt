...
class ComicPosterViewholder(view: View): RecyclerView.ViewHolder(view), IComicViewholder{
    private var diamondCode = ""
    private val poster: ImageView? = view.findViewById(R.id.comic_grid_poster)
    private val title: TextView? = view.findViewById(R.id.comic_grid_title)
